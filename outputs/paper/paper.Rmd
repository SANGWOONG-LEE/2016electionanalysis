...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 3: Distribution of survey respondents' vote choice") +
  theme(legend.position = "none")
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       y = element_blank(),
       title = "Is the US Governemnt Spending Enough to Improve Conditions of Black Population?",
       caption = "Figure 4: Opinion on National Spending on Improving Conditions of Black Population") +
  facet_wrap(~ pres16) + 
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 5: Distribution of survey respondents' vote choice by birth place",
       fil = "Candidate")
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       y = element_blank(),
       title = "Is the US Government Spending Enough on Welfare?",
       caption = "Figure 6: Opinion on National Spending on welfare") +
  facet_wrap(~ pres16) + 
  theme(legend.title = element_blank())
```
