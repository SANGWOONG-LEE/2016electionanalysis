...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 7: Opinion on national spending on welfare") +
  facet_wrap(~ pres16) + 
  theme(legend.title = element_blank())
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 8: Distribution of votes by degree and family income")
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 9: Opinion on wheter the US should limit immigration to protect their culture") +
  facet_wrap(~pres16)
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 10: Surveyee's opinion on government's budget on education improvement")
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 11: Surveyee's opinion on government's budget on arms")
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 12: Surveyee's opinion on government's budget on assisting the poor")
...
reduced_data %>%
  ...
  labs(x = element_blank(),
       ...
       caption = "Figure 13: Surveyee's opinion on government's budget on assisting other countries")
```
